...
keywords:
  ...
  - cli database in spraxium
  - cli cli database guide
  - cli database discord bot
  - cli database typescript
  - spraxium cli documentation
  - cli database cli
faq:
  - question: "What does \"CLI Database\" cover in Spraxium?"
    answer: "How spraxium database scaffolds a complete ORM integration module in seconds. Choose your ORM and database engine through the interactive wizard, then start writing queries immediately."
  - question: "When should I use \"CLI Database\"?"
    answer: "Use this page when you are implementing cli database in the CLI area of your bot architecture."
  - question: "What should I read after \"CLI Database\"?"
